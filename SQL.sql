...
CREATE TABLE oficina (
  ...
  CONSTRAINT PK_oficina_codigo_empleado PRIMARY KEY (codigo_oficina)
);
...
CREATE TABLE detalle_pedido (
  ...
  CONSTRAINT PK_detalle_pedido_codigo_pedido_codigo_producto PRIMARY KEY (codigo_pedido,codigo_producto),
...
CREATE TABLE pago (
  ...
  CONSTRAINT PK_codigo_cliente_id_transaccion PRIMARY KEY (codigo_cliente,id_transaccion),
